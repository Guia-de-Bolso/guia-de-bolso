...
| **Favoritos offline** | `lib/favoritosOffline.js` → IndexedDB; imagens em Cache API; sync em `lib/favoritosOfflineFetch.js`; shell em `public/sw.js` + `lib/serviceWorker.js` |
