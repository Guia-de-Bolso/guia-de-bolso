...
| `perfil_promo_ate` | `date` | Fim da promo de perfil completo gratuito (Lançamento). Após a data, estabelecimento comercial volta ao perfil básico (Presença) salvo `eh_parceiro` *(migration: `lugares_perfil_promo.sql`)* |
