...
const items = [
  ...
  mk("l-03", "L", "Sino alertas com links operacionais", { route: "/admin", roles: ["admin"], expected: "Links avaliações parceiros logs.", tags: ["admin"] }),
  ...
  mk("l-07", "L", "Atalhos operacionais dashboard", { route: "/admin", roles: ["admin"], expected: "Links parceiros vencendo e curadoria.", tags: ["admin"] }),
  ...
  mk("l-16", "L", "Parceiro ativo → home Parceiros", { route: "/", roles: ["admin"], expected: "Carrossel e badge no app.", tags: ["admin", "home"] }),
  mk("l-17", "L", "CRM parceiros filtros vencendo", { route: "/admin/parceiros", roles: ["dev"], expected: "Filtros vencendo/curadoria funcionam.", tags: ["admin"] }),
