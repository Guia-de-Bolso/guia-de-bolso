...
/** Categorias fora do app por enquanto (mantidas no catálogo para reativação futura). */
export const CATEGORIAS_OCULTAS = new Set(["Hospedagem"]);
...
export function isCategoriaOculta(nome) {
  return CATEGORIAS_OCULTAS.has(nome);
}
