...
assert.equal(curadoriaBadge.perfil, "completo");
assert.equal(curadoriaBadge.showGaleriaCompleta, true);
assert.equal(curadoriaBadge.showVideo, true);
assert.equal(curadoriaBadge.showBadgeCuradoria, true);
assert.equal(curadoriaBadge.showClaimCta, false);
assert.equal(isPerfilBasico(curadoriaBadge), false);
