...
/**
 * SHA-256 do certificado de upload/release.
 ...
 * Não inclui www — redireciona para o apex e quebra a verificação.
 */
export const APP_LINK_HOSTS = new Set([SITE_DOMAIN, "app.guiadebolso.app"]);
