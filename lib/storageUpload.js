...
import { validateVideoFile } from "@/lib/videoUpload";
 ...
 * Valida duração/tamanho no cliente; não transcodifica.
 * @param {import('@supabase/supabase-js').SupabaseClient} supabase
 * @param {string} bucket
 ...
 * @returns {Promise<string>}
 */
export async function uploadEntityVideo(supabase, bucket, entityId, file) {
  await validateVideoFile(file);

  const ext = getVideoFileExtension(file);
