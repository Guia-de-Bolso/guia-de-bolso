 ...
 *
 * - Locais públicos (Natureza, trilhas etc.): perfil completo.
 * - Estabelecimento com `conteudo_curadoria`: perfil completo (curadoria da equipe).
 ...
 * - Outros estabelecimentos sem curadoria/parceiro/promo: perfil básico (teaser) — capa,
 *   descrição curta, IR AGORA, WhatsApp/telefone; Instagram, cardápio, site e avaliações
 *   no plano pago.
 */
 ...
 * @param {boolean} [ehCuradoria] - Curadoria da equipe (`conteudo_curadoria`) — perfil completo.
