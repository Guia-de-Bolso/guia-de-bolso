...
assert.equal(isFavoritosOfflinePath("/favoritos/roteiro/uuid"), true);
assert.equal(isFavoritosOfflinePath("/favoritos/atrativo/uuid"), true);
assert.equal(isFavoritosOfflinePath("/"), false);
assert.equal(isFavoritosOfflinePath("/roteiros"), false);
...
assert.ok(paths.includes("/favoritos/roteiro/r2"));
