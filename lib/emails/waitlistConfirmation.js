          ...
          <tr>
            <td style="padding:32px 28px 24px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;line-height:1.65;color:${BRAND.muted};">
                Estamos finalizando o lançamento do app nas lojas. Assim que estiver disponível para download, você será um dos primeiros a saber — com praias, gastronomia e rotas curadas de Imbituba no bolso.
              </p>
