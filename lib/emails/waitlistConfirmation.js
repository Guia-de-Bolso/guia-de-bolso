...
export function getWaitlistConfirmationSubject() {
  return "Você está na lista — Guia de Bolso";
}
...
export function buildWaitlistConfirmationText() {
  return [
    "Olá!",
    "",
    "Seu e-mail foi cadastrado na lista de espera do Guia de Bolso.",
    "",
    "Estamos preparando o lançamento do app nas lojas e você será um dos primeiros a saber quando estiver disponível para download.",
    "",
    `Enquanto isso, explore o guia online: ${SITE_PUBLIC_URL}`,
    "",
...
<head>
  ...
  <title>Lista de espera — Guia de Bolso</title>
</head>
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:520px;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 8px 32px rgba(10,22,18,0.08);">
          <tr>
            <td style="background:linear-gradient(135deg,${BRAND.primary} 0%,#0f2e24 100%);padding:32px 28px;text-align:center;">
              ...
              <h1 style="margin:0;font-size:26px;font-weight:600;line-height:1.2;color:#ffffff;letter-spacing:-0.03em;">Você está na lista ✓</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:32px 28px 24px;">
              <p style="margin:0 0 16px;font-size:16px;line-height:1.65;color:${BRAND.ink};">
                Olá! Seu cadastro na lista de espera foi confirmado.
              </p>
              <p style="margin:0 0 24px;font-size:15px;line-height:1.65;color:${BRAND.muted};">
                Estamos finalizando o lançamento do app nas lojas. Assim que estiver disponível para download, você será um dos primeiros a saber — com praias, gastronomia e atrativos curados de Imbituba no bolso.
              </p>
              <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 auto 24px;">
                <tr>
                  <td style="border-radius:999px;background:${BRAND.primary};">
                    <a href="${SITE_PUBLIC_URL}" style="display:inline-block;padding:14px 28px;font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;letter-spacing:-0.01em;">
                      Explorar o guia online
                    </a>
                  </td>
                </tr>
              </table>
