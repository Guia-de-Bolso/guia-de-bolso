...
export const NEGOCIOS_HERO = {
  ...
  subtitle:
    "O app é gratuito para quem visita a cidade. Seu negócio entra no guia oficial com presença básica ou perfil completo na fase de lançamento — e pode evoluir para Parceiro com destaque premium, relatórios e badge verificado.",
...
export const NEGOCIOS_PLANOS_TIERS = [
  {
    ...
    descricao:
      "Farmácias, mercados, mecânicos e serviços de saúde. O turista encontra, vê horário e vai — com WhatsApp liberado.",
    features: [
      "Nome, endereço e horário ao vivo no app",
      "Botão IR AGORA (Google Maps, Apple Maps, Waze)",
      "WhatsApp / telefone clicável",
      "1 foto de capa e descrição curta",
...
export const NEGOCIOS_APP_TOUCHPOINTS = [
  ...
  },
  {
    ...
    body: "Presença: horário, mapa e WhatsApp. Lançamento e Parceiro: galeria, cardápio, Instagram, avaliações e IR AGORA.",
    screen: "detalhe",
  },
  {
    id: "busca",
...
export const NEGOCIOS_FAQ = [
  {
    ...
    resposta:
      "Depende do plano. Presença é grátis para sempre (utilitários como farmácia e mercado). Restaurantes e experiências têm perfil completo grátis até fev/2027 (Lançamento). Parceiro é o plano pago com destaque na home, IA, QR Code e relatórios — a partir de R$ 299/mês, sob consulta.",
  },
  {
    pergunta: "Existe cadastro gratuito para negócios?",
    resposta:
      "Sim. Todo estabelecimento comercial pode ter presença básica no guia (nome, horário, mapa, WhatsApp). Perfil completo com galeria, links e avaliações é gratuito na fase de Lançamento para restaurantes e experiências, ou permanente no plano Parceiro pago.",
  },
  {
    pergunta: "Qual a diferença entre Presença, Lançamento e Parceiro?",
    resposta:
      "Presença: básico + WhatsApp — ideal para farmácias e mercados. Lançamento: perfil completo grátis até fev/2027 — ideal para gastronomia e experiências. Parceiro: tudo do completo + carrossel na home, badge, prioridade na IA, QR Code e relatório mensal.",
  },
  {
    pergunta: "O que acontece depois de fev/2027?",
    resposta:
      "Quem estava no Lançamento volta ao perfil básico (Presença) ou pode virar Parceiro para manter o perfil completo e ganhar visibilidade premium — com dados reais de visualizações e engajamento para decidir.",
  },
  {
...
export const NEGOCIOS_VALUE_PROPS = [
  {
    ...
    body: "Farmácias e mercados no mapa com horário e WhatsApp — utilidade real para morador e turista.",
    icon: "💊",
  },
  {
