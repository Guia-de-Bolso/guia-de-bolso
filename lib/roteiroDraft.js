...
/** Abre o fluxo de IA na home (perfil, login OAuth). */
export const ROTEIRO_MONTAR_DIA_QUERY = "montarDia=1";

export const ROTEIRO_HOME_PATH = "/";

export const ROTEIRO_MONTAR_DIA_PATH = `/?${ROTEIRO_MONTAR_DIA_QUERY}`;

export const ROTEIRO_RETURN_PATH = `/?${ROTEIRO_RESUME_QUERY}`;
