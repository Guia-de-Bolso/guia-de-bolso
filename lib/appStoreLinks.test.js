...
assert.equal(isStoreLinkConfigured(APP_STORE_URL), true);
...
assert.equal(getAppStoreLinks().appStore, APP_STORE_URL);
assert.equal(getAppStoreLinks().playStore, PLAY_STORE_URL);
