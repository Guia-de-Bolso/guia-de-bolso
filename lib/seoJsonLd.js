...
const PUBLISHER = {
  ...
  description:
    "App e guia turístico de Imbituba, Santa Catarina — praias, gastronomia e atrativos. Não tem relação com serviços financeiros.",
};
...
export function buildAtrativoJsonLd(rota) {
  ...
  const url = `${getSiteUrl()}/atrativos/${rota.id}`;
  ...
  return toJsonLdGraph([
    {
      ...
      url,
      description: truncateMetaDescription(
        "Guia oficial de Imbituba — praias, trilhas, gastronomia e atrativos."
      ),
      inLanguage: "pt-BR",
      publisher: PUBLISHER,
    },
  ...
  return toJsonLdGraph([
    {
      ...
      url,
      description: truncateMetaDescription(
        "Guia turístico de Imbituba, SC — praias, gastronomia, atrativos e lugares curados."
      ),
      inLanguage: "pt-BR",
      publisher: PUBLISHER,
    },
    ...
    faq: [
      {
        ...
        answer:
          "Visite praias como Praia da Vila e região da Praia do Rosa, faça trilhas, experimente a gastronomia local e use o Guia de Bolso para horários e atrativos atualizados.",
      },
      {
