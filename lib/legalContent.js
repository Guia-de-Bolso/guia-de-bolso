...
export const PRIVACIDADE_SECTIONS = [
  {
    ...
    paragraphs: [
      ...
      `Para exercer seus direitos ou tirar dúvidas sobre privacidade, entre em contato: ${LEGAL_RESPONSAVEL.email} ou WhatsApp ${LEGAL_RESPONSAVEL.telefone}.`,
    ],
  },
  {
    id: "dados",
...
export const TERMOS_SECTIONS = [
  {
    ...
    paragraphs: [
      ...
      `Operador: ${LEGAL_RESPONSAVEL.nome} — contato: ${LEGAL_RESPONSAVEL.email} · WhatsApp ${LEGAL_RESPONSAVEL.telefone}.`,
    ],
  },
  {
    id: "servico",
