...
export const PRIVACIDADE_SECTIONS = [
  {
    ...
    title: "1. Quem somos",
    paragraphs: [
      `O ${LEGAL_RESPONSAVEL.produto} é um aplicativo de descoberta turística e local para ${LEGAL_RESPONSAVEL.local}.`,
      `O controlador dos dados pessoais é ${LEGAL_RESPONSAVEL.razaoSocial}, inscrita no CNPJ ${LEGAL_RESPONSAVEL.cnpj}, representada por ${LEGAL_RESPONSAVEL.nome}, responsável pela operação do serviço.`,
      `Encarregado pelo tratamento de dados pessoais (contato para privacidade e direitos do titular): ${LEGAL_RESPONSAVEL.email} · WhatsApp ${LEGAL_RESPONSAVEL.telefone}.`,
    ],
  },
  {
    id: "dados",
    ...
    paragraphs: [
      ...
      "Cadastros anteriores de interesse: e-mails informados antes da publicação nas lojas podem permanecer armazenados para comunicação sobre o app, até você solicitar exclusão.",
      "Estabelecimentos parceiros: quando um negócio adere ao programa Parceiro (gratuito promocional ou pago), tratamos dados do responsável e do estabelecimento (nome, CNPJ/CPF, endereço, contato, fotos e textos do perfil) para publicação no guia, relatórios e cumprimento do contrato de parceria.",
    ],
  },
  {
    id: "finalidades",
    ...
    paragraphs: [
      ...
      "Comunicação: responder solicitações enviadas ao e-mail de contato e comunicações contratuais com estabelecimentos parceiros.",
  ...
  },
  {
    ...
    paragraphs: [
      "Execução de contrato ou procedimentos preliminares: cadastro, favoritos, avaliações, funcionalidades da conta e relação comercial com estabelecimentos parceiros.",
      "Consentimento: geolocalização no navegador ou dispositivo, envio de SMS para login e, quando aplicável, comunicações opcionais.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Resend: envio de e-mails transacionais, quando aplicável.",
      "Apple (Sign in with Apple): na versão iOS (App Store), o login com Apple está disponível. Recebemos identificadores de login, e-mail (se você autorizar compartilhar) e nome conforme suas preferências na Apple.",
  ...
  },
  {
    ...
    paragraphs: [
      "O Guia de Bolso está disponível na App Store (iOS) e no Google Play (Android) por meio de um aplicativo nativo que exibe o mesmo serviço web em um componente de navegação do sistema.",
  ...
  {
    id: "planos",
    title: "12. Planos pagos e parceiros comerciais",
    paragraphs: [
      "Usuários finais (turistas): funcionalidades premium de IA podem ser oferecidas mediante assinatura; quando disponíveis, informaremos preço, renovação e cancelamento na tela de contratação e nesta política.",
      "Estabelecimentos: o Plano Parceiro do Guia é contratado diretamente com o operador (programa promocional ou plano pago). Dados do negócio são tratados para divulgação no app, relatórios de desempenho e cobrança quando aplicável. Pagamentos recorrentes de parceiros, quando ativos, podem ser processados por parceiro de pagamentos brasileiro (ex.: Asaas), que trata dados necessários à transação conforme sua própria política.",
      "Não vendemos dados pessoais de usuários ou de estabelecimentos a terceiros para marketing.",
    ],
  },
  {
    id: "notificacoes",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Em caso de incidente de segurança com risco relevante aos titulares, comunicaremos os afetados e a ANPD quando exigido pela LGPD (art. 48).",
    ],
  },
  {
    id: "menores",
...
export const EXCLUIR_CONTA_SECTIONS = [
  {
    ...
    paragraphs: [
      ...
      `Operador: ${LEGAL_RESPONSAVEL.nome}. Para dúvidas ou pedidos: ${LEGAL_RESPONSAVEL.email} ou WhatsApp ${LEGAL_RESPONSAVEL.telefone}.`,
    ],
  },
  {
    id: "passos",
...
export const TERMOS_SECTIONS = [
  {
    ...
    paragraphs: [
      ...
      `Operador: ${LEGAL_RESPONSAVEL.razaoSocial}, CNPJ ${LEGAL_RESPONSAVEL.cnpj}, nome fantasia ${LEGAL_RESPONSAVEL.produto}, representada por ${LEGAL_RESPONSAVEL.nome}. Contato: ${LEGAL_RESPONSAVEL.email} · WhatsApp ${LEGAL_RESPONSAVEL.telefone}.`,
    ],
  },
  {
    id: "servico",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Login disponível via Google, SMS e, no app iOS, Sign in with Apple. Você é responsável pelo uso da sua conta.",
    ],
  },
  {
    id: "uso",
  ...
  {
    id: "planos",
    title: "7. Planos comerciais",
    paragraphs: [
      "Estabelecimentos podem aderir ao Plano Parceiro do Guia (visibilidade premium no app) mediante contrato com o operador. Condições, preço, período promocional e cancelamento constam do instrumento contratual assinado com cada parceiro.",
      "Usuários finais podem ter acesso a funcionalidades premium (ex.: IA ilimitada) mediante assinatura, quando disponível. Preços e cancelamento serão informados na contratação.",
      "O uso gratuito do app por turistas não exige pagamento, salvo planos opcionais claramente identificados.",
    ],
  },
  {
    id: "pi",
  ...
  },
  {
    ...
    title: "12. Contato",
    paragraphs: [
      `Dúvidas sobre estes termos: ${LEGAL_RESPONSAVEL.email} ou WhatsApp ${LEGAL_RESPONSAVEL.telefone}.`,
    ],
  },
];
