import { buildFavoritosPrecachePaths } from "./serviceWorkerPaths.js";
...
/**
 * Worker ativo, se existir. Não usa `serviceWorker.ready` — essa Promise
 * nunca resolve no `next dev` (SW não é registrado) e trava a UI.
