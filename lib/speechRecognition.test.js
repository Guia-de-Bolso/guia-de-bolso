...
assert.equal(
  formatSpeechError(new Error("popup-timeout")),
  VOICE_SEARCH_MESSAGES.POPUP_TIMEOUT
);
assert.equal(
  formatSpeechError(new Error("NO_SPEECH_HANDLER")),
  VOICE_SEARCH_MESSAGES.POPUP_UNAVAILABLE
);
